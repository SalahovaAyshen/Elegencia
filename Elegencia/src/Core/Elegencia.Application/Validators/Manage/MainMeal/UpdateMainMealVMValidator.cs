...
namespace Elegencia.Application.Validators.Manage.MainMeal
{
    public class UpdateMainMealVMValidator:AbstractValidator<UpdateMainMealVM>
    {
        private const int MinNameLength = 2;
        private const int MaxNameLength = 100;
        public UpdateMainMealVMValidator()
        {
            RuleFor(r => r.Name)
