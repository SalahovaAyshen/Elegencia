...
namespace Elegencia.Application.Validators.Manage.Dessert
{

    public class CreateDessertVMValidator:AbstractValidator<CreateDessertVM>
    {
        private const int MinNameLength = 2;
        private const int MaxNameLength = 100;
        public CreateDessertVMValidator()
        {
            RuleFor(r => r.Name)
